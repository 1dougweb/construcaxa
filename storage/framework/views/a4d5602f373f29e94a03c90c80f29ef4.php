                    ...
                    <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" 
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                >
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['google_maps_api_key'];
        ...
        function notificationSettings() {
            return {
                ...
                async loadAvailableSounds() {
                    try {
                        const response = await fetch('<?php echo e(route('notifications.sounds')); ?>');
...
<?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/admin/settings.blade.php ENDPATH**/ ?>