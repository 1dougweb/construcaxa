            ...
            <li class="relative overflow-hidden rounded-md">
                ...
                <a href="<?php echo e(route('projects.show', $project)); ?>" class="block px-4 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <div class="relative flex items-center justify-between">
                        ...
                        <p class="text-sm text-indigo-700 dark:text-indigo-400"><?php echo e($computedProgress); ?>% <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalTasks>0): ?>· <?php echo e($doneTasks); ?>/<?php echo e($totalTasks); ?> tarefas <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></p>
                    </div>
                </a>
            </li>
