<div>
        ...
        <div class="bg-blue-500 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold">R$ <?php echo e(number_format($financialData['balance'] ?? 0, 2, ',', '.')); ?></p>
                    <p class="text-blue-100 text-xs mt-1">
                        Recebido: R$ <?php echo e(number_format($financialData['received_receivables'] ?? 0, 2, ',', '.')); ?>
        ...
        <div class="bg-purple-400 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold">R$ <?php echo e(number_format($financialData['forecast_30'] ?? 0, 2, ',', '.')); ?></p>
                    <p class="text-purple-100 text-xs mt-1">
                        Crescimento: <?php echo e(number_format($financialData['growth']['percentage'] ?? 0, 2, ',', '.')); ?>%
                    </p>
                </div>
        ...
        <div class="bg-indigo-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold">R$ <?php echo e(number_format($financialData['stock_value'] ?? 0, 2, ',', '.')); ?></p>
        ...
        <div class="bg-orange-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold">R$ <?php echo e(number_format($financialData['reserved_materials_cost'] ?? 0, 2, ',', '.')); ?></p>
    ...
    <script>
        ...
        function initializeFinancialCharts() {
            ...
            const monthsData = <?php echo json_encode($financialData['months_data'] ?? [], 15, 512) ?>;
            const payablesByStatus = <?php echo json_encode($financialData['payables_by_status'] ?? [], 15, 512) ?>;
            const receivablesByStatus = <?php echo json_encode($financialData['receivables_by_status'] ?? [], 15, 512) ?>;
            const forecast30 = <?php echo json_encode($financialData['forecast_30'] ?? 0, 15, 512) ?>;
            const forecast60 = <?php echo json_encode($financialData['forecast_60'] ?? 0, 15, 512) ?>;
            const forecast90 = <?php echo json_encode($financialData['forecast_90'] ?? 0, 15, 512) ?>;
...
<?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/livewire/financial-dashboard.blade.php ENDPATH**/ ?>