...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="version" value="<?php echo e(old('version', 1)); ?>" min="1" required class="w-full border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="status" required class="w-full border-gray-300 rounded-md">
                            <?php $__currentLoopData = \App\Models\ProjectBudget::getStatusOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="discount" value="<?php echo e(old('discount', 0)); ?>" step="0.01" min="0" class="w-full border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3" class="w-full border-gray-300 rounded-md"><?php echo e(old('notes')); ?></textarea>
                ...
                <div>
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <button type="button" onclick="addItem('labor')" class="px-3 py-1 bg-amber-400 text-white rounded-md text-sm hover:bg-amber-500">
                    ...
                    <div class="flex justify-end">
                        <div class="w-64 space-y-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span id="discount-display" class="font-medium">R$ 0,00</span>
                            </div>
                            <div class="flex justify-between border-t pt-2">
                                <span class="font-semibold text-gray-900">Total:</span>
                                <span id="total" class="font-semibold text-lg text-indigo-600">R$ 0,00</span>
                            </div>
                        </div>
                    </div>
                </div>
