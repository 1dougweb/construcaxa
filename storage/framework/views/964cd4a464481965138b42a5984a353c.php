                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        <form method="GET" class="flex flex-wrap gap-4">
                            ...
                            <a href="<?php echo e(route('equipment-requests.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 focus:bg-gray-400 active:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Limpar
                            </a>
                        </form>
                    </div>

                    <?php if($equipmentRequests->isEmpty()): ?>
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Comece criando uma nova requisição de equipamento.</p>
                            <div class="mt-6">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create service-orders')): ?>
                                <a href="<?php echo e(route('equipment-requests.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php else: ?>
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $equipmentRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            <a href="<?php echo e(route('equipment-requests.show', $request)); ?>" class="hover:text-indigo-600">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-4">
                                                ...
                                                <a href="<?php echo e(route('equipment-requests.show', $request)); ?>" class="text-gray-600 hover:text-gray-900">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit service-orders')): ?>
                                                    ...
                                                    <a href="<?php echo e(route('equipment-requests.edit', $request)); ?>" class="text-indigo-600 hover:text-indigo-900">
                                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view service-orders')): ?>
                                                <a href="<?php echo e(route('equipment-requests.pdf', $request)); ?>" class="text-indigo-600 hover:text-indigo-900" target="_blank">
                                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                    </svg>
                                                </a>
