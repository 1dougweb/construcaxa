<div>
    <!--[if BLOCK]><![endif]--><?php if($suppliers->isEmpty()): ?>
        <div class="text-center py-8">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum fornecedor encontrado</h3>
    ...
    <?php else: ?>
        ...
        <div class="mb-4">
            <div class="flex gap-2">
                ...
                <select wire:model.live="categoryFilter" class="border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 px-4 py-2">
                ...
                <!--[if BLOCK]><![endif]--><?php if($searchTerm || $categoryFilter): ?>
                    <button wire:click="clearSearch" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 text-sm">
                        Limpar
                    </button>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                                    <a href="<?php echo e(route('suppliers.edit', $supplier)); ?>" class="hover:text-indigo-600">
                                        <?php echo e($supplier->company_name); ?>

                                    </a>
                                </div>
                                <!--[if BLOCK]><![endif]--><?php if($supplier->trading_name): ?>
                                    <div class="text-sm text-gray-500"><?php echo e($supplier->trading_name); ?></div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($supplier->phone); ?></div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-4">
                                    ...
                                    <a href="<?php echo e(route('suppliers.edit', $supplier)); ?>" class="text-indigo-600 hover:text-indigo-900">
                                    ...
                                    <button wire:click="confirmDelete(<?php echo e($supplier->id); ?>)" class="text-red-600 hover:text-red-900">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Tem certeza que deseja excluir o fornecedor <strong><?php echo e($supplierToDelete->company_name); ?></strong>? Esta ação não pode ser desfeita.
                                    </p>
                                </div>
                            </div>
                        </div>
