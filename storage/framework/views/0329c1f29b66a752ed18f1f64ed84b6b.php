                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-3">
                                                <a
                                                    href="<?php echo e(route('contracts.show', $contract)); ?>"
                                                ...
                                                <button
                                                    type="button"
                                                    onclick="loadContractForm(<?php echo e($contract->id); ?>)"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($contract->file_path): ?>
                                                    <a
                                                        href="<?php echo e(route('contracts.download', $contract)); ?>"
...
<?php /**PATH C:\Users\Douglas\Documents\Projetos\construcaxa\resources\views/contracts/index.blade.php ENDPATH**/ ?>