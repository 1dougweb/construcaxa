...
<?php $component->withAttributes([]); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-4">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit service-orders')): ?>
                                                    ...
                                                    <button 
                                                        onclick="openOffcanvas('equipment-request-offcanvas'); window.dispatchEvent(new CustomEvent('edit-equipment-request', { detail: { id: <?php echo e($request->id); ?> } }));" 
                                                        type="button"
    ...
    <!-- Offcanvas para Nova/Editar Requisição de Equipamento -->
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2206658840-0', 'equipment-request-form');
...
<script>
    ...
    window.addEventListener('edit-equipment-request', (event) => {
        ...
        if (title) {
            title.textContent = 'Editar Requisição de Equipamento';
        }
    ...
    document.addEventListener('click', (e) => {
        if (e.target.closest('[onclick*="equipment-request-offcanvas"]') && !e.target.closest('[onclick*="edit-equipment-request"]')) {
            const offcanvas = document.getElementById('equipment-request-offcanvas');
            const title = offcanvas.querySelector('h2');
            if (title) {
                title.textContent = 'Nova Requisição de Equipamento';
            }
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Douglas\Documents\Projetos\construcaxa\resources\views/equipment-requests/index.blade.php ENDPATH**/ ?>