<div x-data="mediaCapture()" class="media-capture-component">
    ...
    <!-- Botão Principal -->
    <button 
        @click="openMediaSelector(<?php echo \Illuminate\Support\Js::from($context)->toHtml() ?>)"
    ...
    <!-- Fotos já enviadas -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($photos) && is_array($photos) && count($photos) > 0): ?>
        <div class="mt-4 grid grid-cols-3 gap-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photoIndex => $photoPath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative">
                    <img src="<?php echo e(asset('storage/' . $photoPath)); ?>" class="w-full h-24 object-cover rounded">
                    <button 
                        wire:click="removePhoto(<?php echo e($context['index'] ?? $context['envIndex']); ?>, <?php echo e($photoIndex); ?><?php echo e(isset($context['elemIndex']) ? ', ' . $context['elemIndex'] : ''); ?>)"
                        class="absolute top-0 right-0 bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs"
                    >
                        ×
                    </button>
...
function mediaCapture() {
    return {
        ...
        openMediaSelector(context) {
            ...
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('uploadContext', context);
...
<?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/livewire/partials/media-capture.blade.php ENDPATH**/ ?>