<div>
    <!--[if BLOCK]><![endif]--><?php if($categories->isEmpty() && !$search): ?>
        <div class="text-center py-8">
            ...
            <p class="mt-1 text-sm text-gray-500">Comece criando uma nova categoria de equipamento.</p>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create products')): ?>
            <div class="mt-6">
                <a href="<?php echo e(route('equipment-categories.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr>
                        ...
                        <th wire:click="sortBy('equipments_count')" class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors">
                            Equipamentos
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-4">
                                    ...
                                    <a href="<?php echo e(route('equipment-categories.edit', $category)); ?>" class="text-indigo-600 hover:text-indigo-900">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button wire:click="confirmDelete(<?php echo e($category->id); ?>)" class="text-red-600 hover:text-red-900">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
