        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <form method="POST" action="<?php echo e(route('financial.accounts-receivable.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="<?php echo e(route('financial.accounts-receivable.index')); ?>" class="mr-4 text-gray-600 hover:text-gray-900">
                                Cancelar
                            </a>
...
<?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/financial/accounts-receivable/create.blade.php ENDPATH**/ ?>