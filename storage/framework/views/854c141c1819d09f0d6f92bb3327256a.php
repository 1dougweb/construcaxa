...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nova Categoria de Fornecedor')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <form method="POST" action="<?php echo e(route('supplier-categories.store')); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/supplier-categories/create.blade.php ENDPATH**/ ?>