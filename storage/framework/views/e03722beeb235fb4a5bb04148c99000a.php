                ...
                const themeObserver = new MutationObserver(() => {
                    ...
                    markers.forEach(m => {
                        if (m.infoWindow && m.infoWindow.getMap()) {
                            ...
                            const project = markers.find(ma => ma.marker === marker)?.project;
                            if (project) {
...
<?php /**PATH C:\Users\drdes\OneDrive\Documentos\Projetos\2025\Novembro\construcaxa\resources\views/livewire/google-maps-component.blade.php ENDPATH**/ ?>