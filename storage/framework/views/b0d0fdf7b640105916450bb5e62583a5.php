<div>
    <!--[if BLOCK]><![endif]--><?php if($categories->isEmpty() && !$search): ?>
                ...
                <thead>
                    <tr>
                        ...
                        <th wire:click="sortBy('equipments_count')" class="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                            Equipamentos
                            <!--[if BLOCK]><![endif]--><?php if($sortField === 'equipments_count'): ?>
                                <span class="ml-1"><?php echo e($sortDirection === 'asc' ? '↑' : '↓'); ?></span>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </th>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-4">
                                    ...
                                    <a href="<?php echo e(route('equipment-categories.edit', $category)); ?>" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button wire:click="confirmDelete(<?php echo e($category->id); ?>)" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!--[if BLOCK]><![endif]--><?php if($categoryToDelete): ?>
...
<?php /**PATH C:\Users\drdes\OneDrive\Documentos\Projetos\2025\Novembro\construcaxa\resources\views/livewire/equipment-category-list.blade.php ENDPATH**/ ?>