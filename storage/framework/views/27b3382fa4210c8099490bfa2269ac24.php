...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('budgets.update', $budget)); ?>" method="POST" id="budgetForm">
            <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="client_id" id="client_id" required class="w-full border-gray-300 rounded-md">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($client->id); ?>" <?php echo e(old('client_id', $budget->client_id) == $client->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <select name="inspection_id" id="inspection_id" class="w-full border-gray-300 rounded-md">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($budget->inspection_id): ?>
                                <option value="<?php echo e($budget->inspection_id); ?>" selected>
                                    Vistoria #<?php echo e($budget->inspection_id); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="version" value="<?php echo e(old('version', $budget->version)); ?>" min="1" required class="w-full border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input
                            type="text"
                            name="address"
                            value="<?php echo e(old('address', $budget->address)); ?>"
                    ...
                    <div>
                        ...
                        <select name="status" required class="w-full border-gray-300 rounded-md">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Models\ProjectBudget::getStatusOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>" <?php echo e(old('status', $budget->status) == $value ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="discount" value="<?php echo e(old('discount', $budget->discount)); ?>" step="0.01" min="0" class="w-full border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3" class="w-full border-gray-300 rounded-md"><?php echo e(old('notes', $budget->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex justify-end">
                        <div class="w-64 space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span id="subtotal" class="font-medium">R$ <?php echo e(number_format($budget->subtotal, 2, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Desconto:</span>
                                <span id="discount-display" class="font-medium">R$ <?php echo e(number_format($budget->discount ?? 0, 2, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between border-t pt-2">
                                <span class="font-semibold text-gray-900">Total:</span>
                                <span id="total" class="font-semibold text-lg text-indigo-600">R$ <?php echo e(number_format($budget->total, 2, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center gap-3 pt-4 border-t">
                    <div class="flex items-center gap-3 text-sm text-gray-500">
                        <span class="inline-flex items-center gap-1">
                            ...
                            Versão atual: <strong class="ml-1">v<?php echo e($budget->version); ?></strong>
                        </span>
        ...
        <div class="mt-4 bg-white shadow rounded-md p-4">
            <form action="<?php echo e(route('budgets.resend', $budget)); ?>" method="POST" id="resendForm" onsubmit="return confirm('Reenviar este orçamento para o cliente agora?');">
                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        const existingItems = <?php echo json_encode($existingItemsData, 15, 512) ?>;
...
<?php endif; ?><?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/budgets/edit.blade.php ENDPATH**/ ?>