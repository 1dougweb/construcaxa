    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('financial.invoices.store')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="<?php echo e(route('financial.invoices.index')); ?>" class="mr-4 text-gray-600">Cancelar</a>
...
<?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/financial/invoices/create.blade.php ENDPATH**/ ?>