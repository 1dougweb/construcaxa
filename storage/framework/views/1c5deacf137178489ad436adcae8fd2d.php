...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Vistoria</label>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1" id="inspection-info"></p>
                        <?php $__errorArgs = ['inspection_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 dark:text-red-400 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
                    ...
                    fetch(`/api/clients/${clientId}/last-inspection`)
                        ...
                        .then(data => {
                            if (data.success && data.inspection) {
                                ...
                                inspectionInfo.className = 'text-xs text-green-600 dark:text-green-400 mt-1';
                            } else {
                                inspectionInfo.textContent = 'Nenhuma vistoria aprovada encontrada para este cliente';
                                inspectionInfo.className = 'text-xs text-gray-500 dark:text-gray-400 mt-1';
                            }
                        })
                        .catch(error => {
...
<?php endif; ?><?php /**PATH C:\Users\drdes\OneDrive\Documentos\Projetos\2025\Novembro\construcaxa\resources\views/budgets/create.blade.php ENDPATH**/ ?>