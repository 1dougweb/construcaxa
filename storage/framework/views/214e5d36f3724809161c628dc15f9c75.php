...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-1" 
                         x-data="{ 
                            layout: (() => {
                                const stored = localStorage.getItem('budgetsLayout');
                                return stored || 'grid';
                            })(),
                            init() {
                                this.updateLayout();
                            ...
                            updateLayout() {
                                ...
                                localStorage.setItem('budgetsLayout', layout);
                        ...
                        <button 
                            @click="layout = 'grid'; updateLayout();"
                            :class="{ 'bg-white dark:bg-gray-600 shadow-sm text-gray-900 dark:text-gray-100': layout === 'grid', 'text-gray-400 dark:text-gray-500': layout !== 'grid' }"
                        ...
                        <button 
                            @click="layout = 'table'; updateLayout();"
                            :class="{ 'bg-white dark:bg-gray-600 shadow-sm text-gray-900 dark:text-gray-100': layout === 'table', 'text-gray-400 dark:text-gray-500': layout !== 'table' }"
                            class="p-2 rounded-md transition-all"
                    ...
                    <a href="<?php echo e(route('budgets.create')); ?>" class="inline-flex items-center px-3 py-2 bg-indigo-600 dark:bg-indigo-700 text-white rounded-md text-sm hover:bg-indigo-700 dark:hover:bg-indigo-600">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $budgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $budget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="space-y-2">
                            <div class="flex space-x-2">
                                <a href="<?php echo e(route('budgets.edit', $budget)); ?>" 
                                   class="action-button flex-1 align-middle text-center px-3 py-3 text-sm bg-indigo-600 dark:bg-indigo-700 text-white rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors">
                                    Editar
                                </a>
                                <a href="<?php echo e(route('budgets.pdf', $budget)); ?>" 
                                   class="justify-center align-middle pt-1 text-red-500 hover:text-red-700 rounded-md transition-colors"
                                   target="_blank" title="Baixar PDF">
                                   <i class="fi fi-sr-file-pdf text-3xl"></i>
                                </a>
                            </div>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($budget->status !== 'approved' && $budget->status !== 'cancelled'): ?>
                            <div class="flex space-x-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($budget->status !== 'approved'): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($budget->status !== 'rejected'): ?>
            ...
            <!-- Pagination -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($budgets->hasPages()): ?>
                <div class="mt-6" id="grid-pagination"><?php echo e($budgets->links()); ?></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>

            <!-- Table View -->
            <div id="table-view" class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg border border-gray-200 dark:border-gray-700 hidden">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($budgets->hasPages()): ?>
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700" id="table-pagination"><?php echo e($budgets->links()); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/budgets/index.blade.php ENDPATH**/ ?>