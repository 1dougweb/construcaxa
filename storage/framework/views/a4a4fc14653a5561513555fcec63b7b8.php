...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label' => 'Fotos', 'maxPhotos' => 20]));
...
foreach (array_filter((['label' => 'Fotos', 'maxPhotos' => 20]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <!--[if BLOCK]><![endif]--><?php if(isset($tempPhotos) && is_array($tempPhotos)): ?>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tempPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tempPhoto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative aspect-square bg-gray-100 rounded-lg overflow-hidden border-2 border-gray-200">
                    <!--[if BLOCK]><![endif]--><?php if($tempPhoto): ?>
                        <img src="<?php echo e($tempPhoto->temporaryUrl()); ?>" alt="Uploading..." class="w-full h-full object-cover">
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <!-- Upload Area -->
        <!--[if BLOCK]><![endif]--><?php if((isset($photos) ? count($photos) : 0) + (isset($tempPhotos) ? count($tempPhotos) : 0) < $maxPhotos): ?>
            <div 
                x-data="{
                    isDragging: false,
                    handleDrop(e) {
                        ...
                        if (files.length > 0) {
                            files.forEach((file, index) => {
                                if ((<?php echo e(isset($photos) ? count($photos) : 0); ?> + <?php echo e(isset($tempPhotos) ? count($tempPhotos) : 0); ?> + index) < <?php echo e($maxPhotos); ?>) {
...
<?php /**PATH C:\Users\Douglas\Documents\Projetos\stock-master\resources\views/components/photo-gallery.blade.php ENDPATH**/ ?>