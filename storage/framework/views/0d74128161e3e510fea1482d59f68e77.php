                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-4">
                                ...
                                <a href="<?php echo e(route('employees.edit', $employee)); ?>" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">
                                ...
                                <form action="<?php echo e(route('employees.destroy', $employee)); ?>" method="POST" class="inline-block">
                                    ...
                                    <button type="submit" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300" onclick="return confirm('<?php echo e(__('Tem certeza que deseja excluir este funcionário?')); ?>')">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
