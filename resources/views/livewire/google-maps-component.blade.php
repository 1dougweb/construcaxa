    ...
    @if(empty($apiKey))
        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-4">
            ...
            <p>Configure a chave da API do Google Maps nas 
                <a href="{{ route('admin.settings') }}" class="underline text-yellow-800">configurações do sistema</a>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="p-4 bg-gray-50 border-b">
                <div>
                    ...
                    <p class="text-sm text-gray-600">{{ count($projects) }} obra(s) localizadas no mapa</p>
                </div>
            </div>
