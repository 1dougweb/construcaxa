                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                                    <a href="{{ route('suppliers.edit', $supplier) }}" class="hover:text-indigo-600">
                                        {{ $supplier->company_name }}
                                    </a>
                                </div>
                                @if($supplier->trading_name)
                                    <div class="text-sm text-gray-500">{{ $supplier->trading_name }}</div>
                                @endif
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-4">
                                    ...
                                    <button wire:click="confirmDelete({{ $supplier->id }})" class="text-red-600 hover:text-red-900">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Tem certeza que deseja excluir o fornecedor <strong>{{ $supplierToDelete->company_name }}</strong>? Esta ação não pode ser desfeita.
                                    </p>
                                </div>
                            </div>
                        </div>
