<div>
    <form wire:submit.prevent="save">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <!-- Estoque Mínimo -->
            <div>
                <label for="min_stock" class="block text-sm font-medium text-gray-700">Estoque Mínimo *</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <!-- Unidade de Medida -->
            <div>
                <label for="measurement_unit" class="block text-sm font-medium text-gray-700">Unidade de Medida *</label>
            ...
            <!-- Rótulo da Unidade -->
            <div>
                <label for="unit_label" class="block text-sm font-medium text-gray-700">Rótulo da Unidade *</label>
