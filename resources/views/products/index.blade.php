<x-app-layout>
    ...
    <x-offcanvas id="stock-movement-offcanvas" title="Movimentação de Estoque" width="w-full md:w-[500px]">
        @livewire('stock-movement-form', ['productId' => null], key('stock-movement-form'))
    </x-offcanvas>
</x-app-layout>
