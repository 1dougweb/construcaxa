        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                        <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">{{ __('Informações do Funcionário') }}</h3>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Nome') }}</label>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $employee->user->name }}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Email') }}</label>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $employee->user->email }}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Cargo') }}</label>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $employee->position }}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Departamento') }}</label>
                                ...
                                @if($employee->cpf)
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('CPF') }}</label>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $employee->cpf }}</p>
                                </div>
                                @endif
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $employee->hire_date->format('d/m/Y') }}</p>
                                </div>
                                @endif
                            ...
                            <div class="mt-6">
                                ...
                                <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $employee->address }}</p>
                            </div>
                            @endif

                            @if($employee->notes)
                            <div class="mt-6">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Observações') }}</label>
                                <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $employee->notes }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">{{ __('Foto de Perfil') }}</h3>
                            <div class="flex justify-center">
                                <img src="{{ Storage::url($employee->profile_photo_path) }}" alt="{{ $employee->user->name }}" class="h-48 w-48 rounded-full object-cover border-4 border-gray-200 dark:border-gray-600">
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Fotos do Funcionário') }}</h3>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="relative group">
                                    <img src="{{ Storage::url($photo) }}" alt="Foto {{ $index + 1 }}" class="w-full h-32 object-cover rounded-lg border border-gray-200 dark:border-gray-700">
                                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-opacity rounded-lg flex items-center justify-center">
                                        <button type="button" onclick="deletePhoto({{ $index }})" class="opacity-0 group-hover:opacity-100 bg-red-600 dark:bg-red-700 text-white px-3 py-1 rounded text-sm hover:bg-red-700 dark:hover:bg-red-600 transition-colors">
                            ...
                            @else
                            <p class="text-sm text-gray-500 dark:text-gray-400 text-center py-8">{{ __('Nenhuma foto adicionada ainda.') }}</p>
                            @endif
                        </div>
                    </div>
                </div>
