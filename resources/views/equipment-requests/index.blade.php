                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        <form method="GET" class="flex flex-wrap gap-4">
                            ...
                            <a href="{{ route('equipment-requests.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 focus:bg-gray-400 active:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Limpar
                            </a>
                        </form>
                    </div>
                                ...
                                @foreach($equipmentRequests as $request)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            <a href="{{ route('equipment-requests.show', $request) }}" class="hover:text-indigo-600">
                                                #{{ $request->number }}
                                            </a>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-4">
                                                ...
                                                <a href="{{ route('equipment-requests.show', $request) }}" class="text-gray-600 hover:text-gray-900">
                                                ...
                                                @can('edit service-orders')
                                                    ...
                                                    <a href="{{ route('equipment-requests.edit', $request) }}" class="text-indigo-600 hover:text-indigo-900">
                                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                @endcan
                                                @can('view service-orders')
                                                <a href="{{ route('equipment-requests.pdf', $request) }}" class="text-indigo-600 hover:text-indigo-900" target="_blank">
                                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                    </svg>
                                                </a>
