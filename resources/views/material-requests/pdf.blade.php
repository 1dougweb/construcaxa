...
<body>
    ...
    <div class="info">
        ...
        @if($materialRequest->employee->cpf)
            <div class="info-row">
                <span class="label">CPF:</span>
                <span>{{ $materialRequest->employee->cpf }}</span>
            </div>
        @endif
        @if($materialRequest->employee->phone)
            <div class="info-row">
                <span class="label">WhatsApp:</span>
                <span>{{ $materialRequest->employee->phone }}</span>
            </div>
        @elseif($materialRequest->employee->user->phone)
            <div class="info-row">
                <span class="label">WhatsApp:</span>
                <span>{{ $materialRequest->employee->user->phone }}</span>
            </div>
        @endif
        @if($materialRequest->serviceOrder)
            <div class="info-row">
                <span class="label">Ordem de Serviço:</span>
                <span>{{ $materialRequest->serviceOrder->number }} - {{ $materialRequest->serviceOrder->client_name }}</span>
            </div>
        @endif
    </div>
    ...
    <div class="signature">
        <div class="signature-line">
            ...
            <div class="signature-role">{{ $materialRequest->employee->position }} - {{ $materialRequest->employee->department }}</div>
            @if($materialRequest->employee->cpf)
                <div class="signature-role">CPF: {{ $materialRequest->employee->cpf }}</div>
            @endif
        </div>
    </div>
