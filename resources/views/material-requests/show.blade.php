                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="mt-4 space-y-4">
                                ...
                                <div>
                                    <span class="text-sm font-medium text-gray-500">{{ __('Obra') }}:</span>
                                    <span class="ml-2 text-sm text-gray-900">{{ optional($materialRequest->project)->name ? ($materialRequest->project->name . ' (' . $materialRequest->project->code . ')') : '-' }}</span>
                                </div>
                            </div>
                        </div>
